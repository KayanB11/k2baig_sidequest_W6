...
export async function loadAssets(levelPkg, tuningDoc) {
  ...
  const playerImg = await loadImageAsync("assets/MiniWolf.png");
  const boarImg = await loadImageAsync("assets/MiniBear.png");
  const leafImg = await loadImageAsync("assets/MiniBunny.png");
  const fireImg = await loadImageAsync("assets/fireSpriteSheet.png");

  const groundTileImg = await loadImageAsync("assets/topRock.png");
  const groundTileDeepImg = await loadImageAsync("assets/bottomRock.png");
  const platformLCImg = await loadImageAsync("assets/topRock.png");
  const platformRCImg = await loadImageAsync("assets/topRock.png");
  const wallLImg = await loadImageAsync("assets/bottomRock.png");
  const wallRImg = await loadImageAsync("assets/bottomRock.png");
